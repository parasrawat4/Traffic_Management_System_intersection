...
while True:
    ...
    if k == ord('e'): #if e is pressed we take pic
        ...
        cv2.waitKey(2000)
        cv2.imwrite('D:\CODING\Trafficmanagement\carcounterimage\clicked'+str(imnum)+'.png', img)
        img = cv2.imread('D:\CODING\Trafficmanagement\carcounterimage\clicked'+str(imnum)+'.png')
        imnum=imnum+1
        ...
        print("CARS ARE : ", car)
        print("BICYCLE ARE : ", bicycle)
        print("BUS ARE : ", bus)
        print("BIKE ARE : ", motorbike)
        print("TRUCK ARE : ",truck)
        print("VEHICLE ARE : ",vehicle)
